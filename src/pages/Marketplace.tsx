...
const Marketplace = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Биржа сварщиков Аргон-Мастер72 - Найдите проверенного специалиста</title>
        <meta
          name="description"
          content="Биржа профессиональных сварщиков Аргон-Мастер72. Сварочный цех, металлоконструкции, ремонт оборудования. Проверенные специалисты с рейтингом и отзывами."
        />
        <meta
          name="keywords"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6 mb-12">
              ...
              <p className="text-xl md:text-2xl text-white/90">
                Любые сварочные работы от проверенных специалистов под контролем Аргон-Мастер72
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center text-white space-y-6">
              ...
              <p className="text-xl text-white/90">
                Присоединяйтесь к бирже Аргон-Мастер72, получайте больше заказов и работайте под
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto prose prose-lg">
              <h2 className="text-2xl font-bold mb-4">
                Биржа сварочных услуг Аргон-Мастер72 — найдите проверенного специалиста
              </h2>
              <p>
                Аргон-Мастер72 представляет уникальную биржу профессиональных сварщиков, где вы можете

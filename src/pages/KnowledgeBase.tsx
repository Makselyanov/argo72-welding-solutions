...
const KnowledgeBase = () => {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Да, по тарифу '24/7' с коэффициентом ×1,5. Звоните: +7 932 620-55-01 или +7 932 620-55-02."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Пришлите фото детали в Telegram (+7 932 620-55-01) или используйте калькулятор на сайте. Точный расчёт — после осмотра."
        }
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        <title>База знаний — сварочный цех, TIG/MIG, ВИК, НК | Аргон-Мастер72 Тюмень</title>
        ...
        <meta name="keywords" content="сварка тюмень, аргонная сварка тюмень, сварочный цех, TIG сварка, MIG сварка, алюминий сварка, нержавейка сварка, сварка меди, сварка латуни, сварка титана, ВИК контроль, УЗК контроль, НК неразрушающий контроль, дефекты сварных соединений, ТЗ на сварку, WPS, аутсорс сварщика, сварщик на час тюмень, ремонт труб сварка, ремонт балконов, ремонт котлов, монтаж металлоконструкций, база знаний сварка, обучение сварке, технология TIG, технология MIG" />
        <link rel="canonical" href="https://argon-master72.ru/baza-znaniy" />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <Card className="mt-8 p-8 text-center bg-gradient-to-r from-primary/10 to-primary/5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" asChild>
                <a href="tel:+79326205501">Позвонить</a>
              </Button>
            </div>
          </Card>
        </div>
